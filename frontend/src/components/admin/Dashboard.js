              ...
              <div className="row pr-4">
                <div className="col-xl-3 col-sm-6 mb-3">
                  <div className="card-dashboard text-white bg-success o-hidden h-100">
                    ...
                    <Link
                      className="next-white clearfix small z-1"
                      to="/admin/products"
                    >
                      <span className="card-footer float-left">View Details</span>
                ...
                <div className="col-xl-3 col-sm-6 mb-3">
                  <div className="card-dashboard text-white bg-info o-hidden h-100">
                    <div className="card-body">
                      <div className="text-center card-font-size">
                        Users:
                        <br />
